...
class TestTraining(unittest.TestCase):
    def setUp(self):
        ...
        self.test_dccm_map_path = self.test_data_path + 'dccm_map/'
        self.test_residues_path = self.test_data_path + 'list_of_residues/'
        self.test_structure_path = self.test_data_path + 'structure/'
